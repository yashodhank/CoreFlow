(function($) {
  ...
  ConditionsBuilder.prototype = {
    ...
    buildConditional: function(ruleData) {
      ...
      select.append($("<option>", {"value": "all", "text": __("All"), "selected": kind == "all"}));
      select.append($("<option>", {"value": "any", "text": __("Any"), "selected": kind == "any"}));
      select.append($("<option>", {"value": "none", "text": __("None"), "selected": kind == "none"}));
      selectWrapper.append(select);
      selectWrapper.append($("<span>", {text: __("of the following rules:")}));
      div.append(selectWrapper);

      var addRuleLink = $("<a>", {style: "margin-right: 5px;", "href": "#", "class": "add-rule octicon octicon-diff-added text-success pull-right", "data-toggle": "tooltip", "data-original-title": __("Add Rule")}).tooltip();
      var _this = this;
      ...
      var addConditionLink = $("<a>", {style: "margin-right: 5px;", "href": "#", "class": "add-condition octicon octicon-git-branch text-success pull-right", "data-toggle": "tooltip", "data-original-title": __("Add Sub-Condition")}).tooltip();
      ...
      var removeLink = $("<a>", {style: "margin-right: 5px;", "class": "remove text-danger octicon octicon-diff-removed pull-right", "href": "#", "data-toggle": "tooltip", "data-original-title": __("Remove This Sub-Condition")}).tooltip();
  ...
  function removeLink() {
    var removeLink = $("<a>", {"class": "octicon octicon-diff-removed", "href": "#", "data-toggle": "tooltip", "data-original-title": __("Remove")}).tooltip();
